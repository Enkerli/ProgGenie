...
//  seam ProgGenie had to cut before this plug-in could exist — while the header was
//  called `ProgGenieExtensionParameterAddresses.h` the kernel looked as though it
//  depended on the melody app.
//
//  Everything that is actually ProgGenie's — key, bars, surprise, freshness,
...
let ProgGenieParameterSpecs = ParameterTreeSpec {
